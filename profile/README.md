...
[TechTools.cz](https://techtools.cz) is our flagship: a suite of around 50 free online tools, including converters, generators, formatters, calculators and editors. No account is required. It runs on a Rails 8 API with a few small Python backends.

[get.techtools.cz](https://get.techtools.cz) is our studio site, with details on our services and how we work. It is available in Czech, English and Russian.
...
Ruby on Rails, Ruby, Python and Flask on the backend. JavaScript, HTML and CSS on the front end. SQLite and PostgreSQL for data. Nginx and Linux for hosting.

## Contact

- Studio and free demo: https://get.techtools.cz
- Free tools: https://techtools.cz
- Email: sales@techtools.cz

© 2026 TechTools s.r.o., Czech Republic
